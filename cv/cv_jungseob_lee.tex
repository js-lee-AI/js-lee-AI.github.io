...
The 64th Annual Meeting of the Association for Computational Linguistics (ACL 2026), San Diego
\vspace{5pt}
...
{\small For \papertitle{KoCheckGPT}, Korean-specialized detection of LLM-generated documents; team M.~Kang, \me{J.~Lee}, S.~Lee --- selected from 79 teams across 28 universities.}
...
\begin{itemize}
  \item \papertitle{The Hallucination Signal Is a Mean Shift: Why Simple Probes Suffice} ---
    \me{J.~Lee}, J.~Seo, H.~Lim ~\textbf{EMNLP 2026} (Main) ~\href{https://arxiv.org/abs/2608.28930}{[\textcolor{accent}{arXiv}]}
  ...
  \item \papertitle{Skin-Deep: A Geometric Diagnostic for Alignment Fragility in LLM Representations} ---
    D.J.~Lee$^{*}$, \me{J.~Lee}$^{*}$, S.~Lee, \textit{et al.} ~\textbf{Findings of AACL-IJCNLP 2026} ($^{*}$equal contribution) ~\href{https://arxiv.org/abs/2606.22676}{[\textcolor{accent}{arXiv}]}
\end{itemize}
