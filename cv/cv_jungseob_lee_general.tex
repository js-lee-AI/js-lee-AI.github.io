...
\begin{minipage}[c]{0.22\textwidth}
  \centering
  \includegraphics[height=4.1cm,trim={170 0 170 0},clip]{photo-2026.png}
\end{minipage}%
\hfill
...
\begin{itemize}
  ...
  \item Press: \href{https://www.korea.ac.kr/bbs/ko/42/120917/artclView.do}{[\textcolor{accent}{Korea University}]} \enspace \href{https://www.aitimes.kr/news/articleView.html?idxno=37944}{[\textcolor{accent}{AI Times}]} \enspace \href{https://www.newstomato.com/ReadNews.aspx?no=1270232}{[\textcolor{accent}{Newstomato}]}
\end{itemize}
\vspace{5pt}
...
\textbf{Outstanding Reviewer Award} \hfill \textit{2026} \\
The 64th Annual Meeting of the Association for Computational Linguistics (ACL 2026), San Diego \\[2pt]
{\small Recognized by the ACL program committee for review quality and service to the conference. \href{https://js-lee-ai.github.io/assets/acl2026-outstanding-reviewer.pdf}{[\textcolor{accent}{Certificate}]}}
\vspace{6pt}
...
\textbf{Minister of Science and ICT Award} \hfill \textit{2023} \\
ICT Challenge 2023, Ministry of Science and ICT (organized by IITP) \\[2pt]
{\small Team M.~Kang, \me{J.~Lee}, S.~Lee, for \papertitle{KoCheckGPT} --- Korean-specialized detection of LLM-generated documents for enterprise security; selected from 79 teams (263 participants) across 28 universities. \href{https://www.yna.co.kr/view/RPR20230926008900353}{[\textcolor{accent}{Press}]}}
...
\subsection*{2026}
\begin{itemize}
  \item \papertitle{The Hallucination Signal Is a Mean Shift: Why Simple Probes Suffice} \\
    \me{J.~Lee}, J.~Seo, H.~Lim \enspace---\enspace \textbf{EMNLP 2026} (Main) \enspace \arxivlink{https://arxiv.org/abs/2608.28930}
  ...
  \item \papertitle{Skin-Deep: A Geometric Diagnostic for Alignment Fragility in Large Language Model Representations} \\
    D.J.~Lee$^{*}$, \me{J.~Lee}$^{*}$, S.~Lee, S.~Hong, S.~Son, S.~Eo, J.~Seo, H.~Lim \enspace---\enspace \textbf{Findings of AACL-IJCNLP 2026} ($^{*}$equal contribution) \enspace \arxivlink{https://arxiv.org/abs/2606.22676} \enspace \codelink{https://github.com/js-lee-AI/skin-deep}
\end{itemize}
